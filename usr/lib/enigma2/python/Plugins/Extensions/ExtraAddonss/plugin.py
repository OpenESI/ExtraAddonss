# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/ExtraAddonss/plugin.py
...
class Getipklist(Screen):
    skin = '\n\t\t<screen position="center,center" size="955,400" title="ExtraAddonss" >\n\t\t\t\n                                       <widget name="list" position="50,20" size="500,300" scrollbarMode="showOnDemand" />\n\n\t\t\t\n\t\t\t<eLabel position="70,100" zPosition="-1" size="100,69" backgroundColor="#222222" />\n\t\t\t<widget name="info" position="150,50" zPosition="4" size="300,300" font="Regular;24" foregroundColor="#ffffff" transparent="1" halign="center" valign="center" />\n\t                  <ePixmap position="5,365" zPosition="4" size="530,40" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ExtraAddonss/about.png" transparent="1" alphatest="on" />\n\t\n\t    <ePixmap position="580,center" zPosition="2" size="500,500" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ExtraAddonss/openesilogo.png" transparent="1" alphatest="on" />\n\t\n\t\t</screen>'
    ...
    def openTest(self):
        ...
        try:
            ...
            self['info'].setText('ExtraAddonss in maintenance ... please try again later')
...
class SelectCountry(Screen):
    skin = '\n\t\t<screen position="center,center" size="950,430" title="ExtraAddonss" >\n\t\t\t  <widget name="countrymenu" position="10,0" size="500,380" scrollbarMode="showOnDemand" />\n\t                  <ePixmap position="5,395" zPosition="4" size="590,40" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ExtraAddonss/about.png" transparent="1" alphatest="on" />\n\t           <ePixmap position="580,center" zPosition="2" size="400,400" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ExtraAddonss/openesilogo.png" transparent="1" alphatest="on" />\n\t</screen>\n\t\t'
...
def Plugins(**kwargs):
    return PluginDescriptor(name='Extra Addons', description=_('Download your favorite plugin from OpenESI'), where=[PluginDescriptor.WHERE_EXTENSIONSMENU, PluginDescriptor.WHERE_PLUGINMENU], icon='addons.png', fnc=main)
